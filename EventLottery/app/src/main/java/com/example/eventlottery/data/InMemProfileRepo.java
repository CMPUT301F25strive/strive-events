...
public class InMemProfileRepo implements ProfileRepository{
    ...
    public EntrantProfile findEntrantById(String id) {
        // Preset profile for US 01.02.02
        EntrantProfile profile = entrants.get(id);
        if (profile == null) {
            profile = new EntrantProfile("Preset name", "preset@gmail.com", "911");
            profile.setDeviceId("301");
            return profile;
        }
