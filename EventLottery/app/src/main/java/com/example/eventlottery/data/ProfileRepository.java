...
public class ProfileRepository {
            ...
            public void onEvent(@Nullable QuerySnapshot querySnapshots, @Nullable FirebaseFirestoreException error) {
                ...
                if (querySnapshots != null) {
                    ...
                    for (QueryDocumentSnapshot doc : querySnapshots) {
                        ...
                        users.add(new Profile(userID, name, email, phone));
                    }
                }
            }
        });
    ...
    public void add(Profile user) {
        ...
        usersRef.document(user.getDeviceID()).update(data).addOnSuccessListener(aVoid -> Log.d("Firestore", "Profile saved"))
     ...
     */
    public Profile getUser(String deviceID) {
